...
public class DamagochiMain { //DamagochiMain class start
	   public void DamagochiMain() {   //메인클래스 생성자
	      ...
	      DamagochiDAO damo = new DamagochiDAO();   //SQL 쿼리 클래스 객체 생성
	...
	////////////////////////////////////////////// 불러오기///////////////////////////////////////////////////////////////////////////////
	         if (putNum.equals("1")) { //1번 if
	             ...
	             while (true) { // while start
	                ...
	                System.out.println("불러오시려는 펫의 이름을 입력해주세요. 뒤로가시려면 1번을 입력하세요");
         ...
         if (putNum.equals("2")) {//2번 if
            ...
            while(true) {
            	System.out.println(
            			...
            			"　　　　\n" + 
            			"");
               System.out.println("생성하시려는 펫의 이름을 입력해주세요. 뒤로가시려면 1를 입력하세요");
               ...
               if (name.equals("1")) {//1을 입력한 경우
                  ...
                  if (damo.insertDamagochi(da1) == 1) { // 디비에 이름이 없어서 새로 만든게 실행되면 1반환
                     System.out.println(name + "을 새로 만들었습니다.");
...
/////////////////////////////////////////////////// 삭제하기////////////////////////////////////////////////////////////////////
         ...
         if (putNum.equals("3")) { //3번 if
            ...
            while (true) { //while start
               ...
               System.out.println("삭제하시려는 펫의 이름을 입력해주세요. 뒤로가시려면 1을 입력하세요");
               ...
               if (delSelect.equals("1")) { //1을 선택한 경우
                  ...
                  if (da1 == null) { // 삭제할 펫이 없을 때
                     System.out.println("해당 이름의 삭제할 펫이 없어요!");
                     try {
