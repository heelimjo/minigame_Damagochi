...
public class DamagochiDAO { // DamagochiDBO class start
	...
	////////////////////////////////////////////////////insert/////////////////////////////////////////////////////////////
	   public int insertDamagochi(Damagochi da) {
	      ...
	      try (PreparedStatement pst = conn.prepareStatement(sql);) {
	         ...
	         System.out.println("이미 생성된 이름이 있습니다."); // 겹치는 것 잇으면 이미 생성된 이름있다고 출력
	      }
	      return cnt; // 적용되면 1반환
	   }
	   ...
	   public void deleteDamagochi(String name) {
	      ...
	      while (true) {
	         ...
	         try (Connection conn = MyConnection.getMakeConnection();
	            ...
	            System.out.println(name + "가 삭제되었음");
	            try {
	               Thread.sleep(3000);
